export const ROLE_CONFIG={
 president:{label:'Président',menus:[['members','👥','Membres'],['secretariat','🗃️','Secrétariat'],['treasury','💼','Trésorerie'],['committee','🏛️','Gestion du Comité'],['reports','📚','Rapports Mensuels'],['archives','🗂️','Archives'],['conflicts','⚖️','Journal des conflits'],['settings','⚙️','Paramètres'],['privacy','🔒','Confidentialité'],['about','ℹ️','À propos']]},

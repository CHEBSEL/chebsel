...
const APP_SHELL=[
  ...
  './js/v2/app-state.js','./js/v2/router.js','./js/v2/role-config.js','./js/v2/storage.js','./js/v2/auth.js','./js/v2/updates.js','./js/v2/members.js','./js/v2/attendance.js','./js/v2/finance.js','./js/v2/notifications.js','./js/v2/admin.js','./js/v2/receipts.js','./js/v2/history-dashboards.js','./js/v2/app.js',

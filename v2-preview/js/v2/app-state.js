...
export const AppState={version:APP_VERSION,boot:{ready:false,error:null},user:null,role:'visitor',route:'home',navigationStack:['home'],data:{members:[],attendance:[],finance:[],settings:{}},ui:{selectedMemberId:null,selectedAttendanceCallId:null},syncStatus:{online:navigator.onLine,state:'idle',lastSync:null,pending:0},notifications:{unread:0,items:[]}};
